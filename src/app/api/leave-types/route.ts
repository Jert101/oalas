...
export async function GET(request: NextRequest) {
  try {
    console.log('🔍 Leave Types API called')
    ...
    // Verify user has appropriate role (Teacher, Dean, or Admin)
    const allowedRoles = ["Teacher/Instructor", "Dean/Program Head", "Admin"]
    ...
    // Return data directly as array for compatibility with both teacher and dean components
