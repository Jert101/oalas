...
export default function NonTeachingStaffDashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const statsResponse = await fetch('/api/non-teaching-staff/dashboard')
      if (statsResponse.ok) {
      ...
      const applicationsResponse = await fetch('/api/non-teaching-staff/recent-applications')
      ...
      const validationResponse = await fetch('/api/non-teaching-staff/validation')
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Button 
              variant="outline" 
              size="sm"
              onClick={() => router.push('/non-teaching-staff/leave')}
            >
              View All
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Get started by applying for your first leave.
                 ...
                 <Button 
                   onClick={() => router.push('/non-teaching-staff/leave/apply')}
                   disabled={!canApply}
                 >
