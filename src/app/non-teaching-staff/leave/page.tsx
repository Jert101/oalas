...
export default function TeacherLeavePage() {
  ...
  const fetchApplications = async () => {
    try {
      setIsLoading(true)
      const response = await fetch('/api/non-teaching-staff/leave-applications')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-col items-start lg:items-end gap-2">
          <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
            <Button 
              variant="outline" 
              onClick={() => router.push('/teacher/leave/archived')}
      ...
      {/* Validation Status */}
      <ValidationStatus onValidationChange={setCanApply} />
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/teacher/leave/${application.id}`)}
                      className="w-full sm:w-auto"
                    >
                      View Details
                    </Button>
