...
export default function DeanLeavePage() {
  ...
  const fetchApplications = async () => {
    try {
      setIsLoading(true)
      const response = await fetch('/api/office-head/leave-applications')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-col items-start lg:items-end gap-2">
          <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
            <Button 
              variant="outline" 
              onClick={() => router.push('/office-head/leave/archived')}
            ...
            <Button 
              onClick={() => router.push('/office-head/leave/apply')}
              disabled={!canApply}
              className="w-full sm:w-auto"
            >
      ...
      <ValidationStatus 
        ...
        validationApi="/api/office-head/validation"
        applyPath="/office-head/leave/apply"
      />
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/office-head/leave/${application.id}`)}
                      className="w-full sm:w-auto"
                    >
                      View Details
                    </Button>
